...
const ArchitecturePage = () => {
    ...
    const fetchArchitecture =
      async () => {
        try {
          ...
          setArchitecture(
            architectureResponse.data.data
          );
  ...
  if (
    error.includes(
      "Architecture analysis not found"
    )
  ) {
    return (
