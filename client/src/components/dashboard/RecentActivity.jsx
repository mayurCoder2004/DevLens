      ...
      {loading ? (
        ...
        <div className="rounded-2xl border border-dashed border-slate-700 bg-slate-900/40 p-10 text-center">
          ...
          <p className="mx-auto mt-3 max-w-lg text-sm leading-6 text-slate-400">
            Repository activity will appear here after you synchronize
            repositories and run engineering analyses.
          </p>
        </div>
      ) : (
        /* Timeline */
          ...
          {activities.map((activity) => {
            ...
            return (
              <ActivityItem
                ...
                repository={activity.repository?.name ?? "Unknown Repository"}
