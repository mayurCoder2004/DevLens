import { Cpu, Sparkles, ArrowRight, ArrowDown } from "lucide-react";
      ...
      <Container className="relative z-10">
        ...
        >
          <div className="inline-flex items-center rounded-full border border-blue-500/20 bg-blue-500/10 px-4 py-2">
            <span className="text-sm font-medium text-blue-400">Workflow</span>
          </div>
          ...
          <p className="mt-4 text-base leading-8 text-slate-400 sm:mt-6 sm:text-lg">
            Connect any GitHub repository and receive AI-powered engineering
            intelligence in just a few minutes.
          </p>
        </motion.div>
            ...
            {steps.map((step, index) => (
              <div key={step.step} className="relative">
                ...
                {index < steps.length - 1 && (
                  ...
                  >
                    <ArrowRight size={30} className="text-slate-700" />
                  </motion.div>
                )}
              </div>
            ))}
