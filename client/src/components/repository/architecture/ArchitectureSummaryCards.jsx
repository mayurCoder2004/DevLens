...
export default function ArchitectureSummaryCards({ architecture }) {
  if (!architecture) {
    return (
    ...
    <section>
      <div className="mb-6">
        ...
        <p className="mt-2 text-slate-400">
          Understand the structure, complexity, and maintainability of your
          repository.
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
        ...
        <ArchitectureMetricCard
          ...
          value={architecture.hasCircularDependency ? "Yes" : "No"}
          subtitle="Detected"
        />
