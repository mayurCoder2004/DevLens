      ...
      <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
        <div className="min-w-0">
          ...
          <p className="mt-3 max-w-xl text-slate-400">
            A consolidated health score generated from architecture, deployment
            readiness, technical debt, engineering health, and AI-powered
            repository analysis.
          </p>
        </div>
        ...
        <div className="flex w-full flex-col items-center rounded-2xl border border-slate-800 bg-slate-950 px-5 py-6 sm:w-auto sm:px-10 sm:py-8">
          <span className={`text-5xl font-bold sm:text-7xl ${getScoreColor()}`}>
            {score}
          </span>

          <span className="mt-3 text-sm text-slate-400">{status}</span>
