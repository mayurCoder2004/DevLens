    ...
    <section className="rounded-2xl border border-slate-800 bg-slate-950/60 p-4 sm:p-6">
      ...
      <div className="grid gap-6 lg:grid-cols-4">
        ...
        <div className="min-h-[180px] rounded-xl border border-slate-700 bg-slate-900 p-5 sm:p-6">
          ...
          <div className="mt-8">
            <p className="break-words text-xl font-bold text-white">{status}</p>
            <p className="mt-3 text-sm text-slate-500">Overall assessment</p>
          </div>
        </div>

        {/* Strengths Count Card */}
        <div className="min-h-[180px] rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-5 sm:p-6">
          <div className="flex items-start justify-between">
        ...
        <div className="min-h-[180px] rounded-xl border border-amber-500/30 bg-amber-500/10 p-5 sm:p-6">
          <div className="flex items-start justify-between">
            <h3 className="text-sm font-medium text-slate-400">
              Recommendations
            </h3>
          ...
          <div className="mt-8">
            <p className="text-4xl font-bold text-amber-400 sm:text-5xl">
